            ...
            <div>
                ...
                <div class="form-line mb-10" :class="{ 'invalid': errors.length }">
                    <div class="flex">
                        ...
                        <button type="button" class="btn btn-black m-w-98" v-else @click="sendAuthNumber()">재전송</button><!-- 인증요청 -> 재전송 -->
                    </div>
                    <span class="feedback">{{ errors[0] }}</span>
                </div>
                </ValidationProvider>
                ...
                <div class="form-line mb-10" :class="{ 'invalid': errors.length }">
                    <div class="flex">
                        ...
                        <button type="button" class="btn btn-black m-w-98" @click="checkAuthNumber()" v-if="!auth">인증하기</button>
                        <button type="button" class="btn btn-black m-w-98" v-else>인증성공</button>
                    </div>
                    <span class="feedback">{{ errors[0] }}</span>
                </div>
                </ValidationProvider>
...
export default {
    ...
    head() {
        return {
            meta: [
                {hid: 'pageTitle', name: 'pageTitle', content: 'SNS 인증하기'}
            ],
            seo: this.seo
        }
    },
