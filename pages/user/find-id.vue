...
export default {
    ...
    async asyncData({$seo}) {
        try {
            ...
            console.log("[find-id.vue] asyncData error: ", error);
            return {}
        }
    },
